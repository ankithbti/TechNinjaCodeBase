	...
	<div class="row">
		<div class="span8">
			<div class="forgotpasswordbox">
				...
				<h4>Sign In / Login via TechNinja</h4>

				<form action="user_login.php" method="POST">
		        	<p><input type="email" name="email" id="text-input" required="required" placeholder="Enter your Email" pattern="^[A-Za-z0-9](([_\.\-]?[a-zA-Z0-9]+)*)@([A-Za-z0-9]+)(([\.\-]?[a-zA-Z0-9]+)*)\.([A-Za-z]{2,})$"></p>
		        	<p><input type="password" name="password" id="text-input" required="required" placeholder="Enter password"></p>
		        	<input type="hidden" name="submitted">
		        	<input type="hidden" name="pageURL" value="<?php echo $_SERVER['PHP_SELF'] ; ?>">
		            <p><input type="submit" name="submit" id="submit" value="Sign In"></p>
		        </form>
